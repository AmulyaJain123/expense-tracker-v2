      ...
      <div className=" mt-8 flex flex-col space-y-[30px] sm:space-y-0 items-center sm:flex-row mx-[50px] md:mx-[100px] justify-center space-x-[20px] 2xl:space-x-[80px]">
        <div className="flex text-sm sm:text-xs lg:text-base xl:text-lg flex-col max-w-[900px] space-y-6  my-auto">
          <p className=" font-medium  text-center ">
            ...
            <span className=" font-medium text-[#9d4edd]">Vault</span>, you can
            effortlessly:
          </p>
          <ul className="flex flex-col list-disc mx-auto">
            <li className="list-item">ADD Text Details</li>

            <li className="list-item">ADD Images and PDFs of your Documents</li>
          ...
          <p className=" font-medium  text-center ">
            ...
            <span className=" font-medium text-green-500">securely stored</span>{" "}
            and{" "}
          ...
          <div className="mt-16 flex flex-col space-y-2">
            <div className=" ">
              ...
              <div className="sm:w-2/3 flex  flex-col space-y-2">
                <p>
                  Navigate to the Vault section below on this page and click on
                  the <span className=" font-medium text-[#9d4edd]">ADD</span>{" "}
            ...
            <div className=" ">
              ...
              <div className="sm:w-2/3 flex flex-col space-y-2">
                <p>
                  You can upload up to four Images/PDFs of your document to keep
                  a visual record of your documents.
                </p>
              </div>
            </div>
            <div className=" ">
            ...
            <div className=" ">
              ...
              <div className="sm:w-2/3 flex flex-col space-y-2">
                <p>
                  After entering all the necessary details and uploading files,
                  click{" "}
            ...
            <div className=" ">
              ...
              <div className="sm:w-2/3 flex flex-col space-y-2">
                ...
                <p>
                  You can also download the files attached to each document for
                  your records.
                </p>
              </div>
            </div>
